    ...
    <div className="min-h-screen bg-[#050505] text-white selection:bg-[#FE7743] selection:text-black font-sans flex flex-col">
      ...
      <main className="flex-1 relative z-10 max-w-7xl mx-auto w-full px-6 py-8">
        ...
        <Button
          onClick={() => router.back()}
          variant="ghost"
          className="mb-6 pl-0 hover:bg-transparent hover:text-[#FE7743] text-gray-400"
        >
            ...
            <div className="relative aspect-video w-full overflow-hidden rounded-lg bg-gray-900 border border-white/10">
              ...
              <div className="absolute top-4 left-4 flex gap-2">
                ...
                {vehicle.condition === "New" && (
                  <Badge className="bg-green-500 text-black font-bold border-0">
                    NEW
                  </Badge>
                )}
              </div>
          ...
          <div className="space-y-8">
            <div>
              <h1 className="text-3xl md:text-4xl font-bold text-white mb-2">
                ...
                <span className="text-[#FE7743]">{vehicle.model}</span>
              </h1>
              ...
              <CardContent className="p-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <Button
                    ...
                    className="bg-[#FE7743] hover:bg-[#FE7743]/90 text-black font-bold h-12"
                  >
