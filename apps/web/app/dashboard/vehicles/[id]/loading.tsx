      ...
      <main className="flex-1 relative z-10 cd-container py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          <div className="space-y-4">
            <div className="aspect-video w-full rounded-lg bg-[#c6c5b9]/20 border border-[#546a7b]/65 animate-pulse" />
            <div className="flex gap-4 overflow-x-auto pb-2">
              {Array.from({ length: 4 }).map((_, index) => (
                <div
                  key={index}
                  className="w-24 h-16 rounded border border-[#546a7b]/65 bg-[#c6c5b9]/20 animate-pulse flex-shrink-0"
                />
              ))}
            </div>
          </div>
