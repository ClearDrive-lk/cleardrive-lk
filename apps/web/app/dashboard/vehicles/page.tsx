...
function VehicleCatalog() {
    ...
    const currentMaxYear = Number(searchParams.get('maxYear')) || new Date().getFullYear();
        ...
        <div className="min-h-screen bg-[#050505] text-white selection:bg-[#FE7743] selection:text-black font-sans flex flex-col">
            ...
            <nav className="border-b border-white/10 bg-[#050505]/80 backdrop-blur-md sticky top-0 z-50">
                <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
                    ...
                    <Button onClick={logout} disabled={isLogoutLoading} className="bg-[#FE7743] text-black hover:bg-[#FE7743]/90 font-bold h-9">
            ...
            <header className="relative z-10 pt-12 pb-8 px-6 border-b border-white/5">
                <div className="max-w-7xl mx-auto">
                    <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-8">
                        ...
                        {(currentSearch || currentFuel !== 'All' || currentStatus !== 'All' || currentMinPrice > 0) && (
                            <Button variant="outline" size="sm" onClick={clearFilters} className="border-red-500/20 text-red-500 hover:bg-red-500/10 hover:text-red-400">
                    ...
                    <div className="flex flex-col gap-4">
                        <div className="flex flex-col lg:flex-row gap-4">
                            ...
                            <div className="flex flex-wrap gap-2">
                                <Select value={currentFuel} onValueChange={(val) => updateFilters({ fuel: val })}>
                                ...
                                <Sheet open={sheetOpen} onOpenChange={setSheetOpen}>
                                    <SheetTrigger asChild>
                                        <Button variant="outline" className="h-10 border-white/10 text-white hover:bg-white/10 hover:text-[#FE7743]">
                                    ...
                                    <SheetContent className="bg-[#0A0A0A] border-white/10 text-white overflow-y-auto">
                                        ...
                                        <div className="space-y-8">
                                            ...
                                            <div className="space-y-4">
                                                ...
                                                <RadioGroup value={selectedTransmission} onValueChange={setSelectedTransmission} className="flex flex-col space-y-2">
                                                    <div className="flex items-center space-x-2">
                                                        <RadioGroupItem value="All" id="t-all" className="border-white/20 text-[#FE7743]" />
                                                        <Label htmlFor="t-all" className="text-gray-300">Any</Label>
                                                    </div>
                                                    <div className="flex items-center space-x-2">
                                                        <RadioGroupItem value="AT" id="t-at" className="border-white/20 text-[#FE7743]" />
                                                        <Label htmlFor="t-at" className="text-gray-300">Automatic (AT)</Label>
                                                    </div>
                                                    <div className="flex items-center space-x-2">
                                                        <RadioGroupItem value="CVT" id="t-cvt" className="border-white/20 text-[#FE7743]" />
                                                        <Label htmlFor="t-cvt" className="text-gray-300">CVT</Label>
                                                    </div>
                                                    <div className="flex items-center space-x-2">
                                                        <RadioGroupItem value="MT" id="t-mt" className="border-white/20 text-[#FE7743]" />
                                                        <Label htmlFor="t-mt" className="text-gray-300">Manual (MT)</Label>
                                                    </div>
                                                </RadioGroup>
                                            </div>
                                        </div>
                                        ...
                                        <SheetFooter className="mt-8">
                                            <Button onClick={applyAdvancedFilters} className="w-full bg-[#FE7743] hover:bg-[#FE7743]/90 text-black font-bold">
                                                Apply Filters
                                            </Button>
                                        </SheetFooter>
                                    </SheetContent>
                        ...
                        <>
                            ...
                            <div className="mt-12 flex flex-col sm:flex-row justify-between items-center gap-4 border-t border-white/5 pt-8">
                                <span className="text-sm text-gray-500">
                                    Showing {(currentPage - 1) * 8 + 1} to {Math.min(currentPage * 8, totalItems)} of {totalItems} entries
                                </span>
