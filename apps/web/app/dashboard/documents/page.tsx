        ...
        <div className="p-6 max-w-7xl mx-auto">
            <div className="mb-8 flex items-center justify-between">
                <div>
                    ...
                    <p className="text-gray-400 mt-2">Manage your invoices, BLs, and customs clearance paperwork.</p>
                </div>
                <Badge variant="outline" className="border-[#FE7743]/20 text-[#FE7743] bg-[#FE7743]/5">
                    BETA ACCESS
                </Badge>
            </div>
            ...
            <div className="rounded-xl border border-white/10 bg-white/5 border-dashed p-12 text-center relative overflow-hidden group">
                ...
                <div className="relative z-10 flex flex-col items-center max-w-md mx-auto">
                    ...
                    <h2 className="text-xl font-bold text-white mb-2">No Documents Available</h2>
                    <p className="text-gray-400 mb-6">
                        Your digital document locker is being provisioned. Once your first order is placed,
                        all related paperwork will appear here automatically.
                    </p>
            ...
            <div className="mt-12 opacity-50 pointer-events-none blur-[1px] select-none">
                <h3 className="text-sm font-bold text-gray-500 uppercase tracking-wider mb-4">Example View</h3>
                    ...
                    {[1, 2, 3].map((i) => (
                        <div key={i} className="flex items-center justify-between p-4 rounded-lg bg-black/20 border border-white/5">
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    <div className="text-white font-medium">Commercial_Invoice_{1000 + i}.pdf</div>
                                    <div className="text-xs text-gray-500">2.4 MB • Uploaded 2 days ago</div>
                                </div>
                            </div>
                            <Button variant="ghost" size="sm" className="text-gray-400"><Download className="w-4 h-4" /></Button>
                        </div>
                    ))}
                </div>
            </div>
