...
export default function TermsPage() {
  return (
    <>
      <Header />
      <main className="min-h-screen bg-[#fdfdff] text-[#393d3f] py-16 dark:bg-[#0f1417] dark:text-[#edf2f7]">
        <div className="cd-container space-y-6">
          ...
          <p className="leading-relaxed text-[#546a7b] dark:text-[#bdcad4]">
            ...
            auction house rules, and payment requirements communicated during
            your order journey.
          </p>
