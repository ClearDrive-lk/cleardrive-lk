        ...
        <div className="min-h-screen w-full flex flex-col items-center justify-center bg-[#050505] relative overflow-hidden font-sans selection:bg-[#FE7743] selection:text-black">
            ...
            <div className="relative z-10 text-center max-w-lg px-6">
                ...
                <p className="text-gray-400 mb-8 leading-relaxed">
                    Public registration is currently closed as we scale our infrastructure.
                    Please contact <span className="text-white font-mono">support@cleardrive.lk</span> for manual onboarding.
                </p>

                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                    <Link href="/">
                        <Button variant="outline" className="border-white/10 hover:bg-white/5 text-white gap-2 w-full sm:w-auto h-12">
