        ...
        {[...Array(10)].map((_, i) => (
          <div key={i} className="flex items-center pr-12">
            ...
            <span className="flex items-center gap-2 mr-12">
              ...
              <span className="text-[#393d3f] font-bold text-xs">¥1.85M</span>
            </span>
            <span className="flex items-center gap-2 mr-12">
              ...
              <span className="text-[#393d3f] font-bold text-xs">¥2.1M</span>
            </span>
            <span className="flex items-center gap-2 mr-12">
              <span className="text-[#546a7b] font-mono text-xs">JPY/LKR</span>
              <span className="text-[#62929e] font-bold text-xs">2.25</span>
            </span>
            <span className="flex items-center gap-2 mr-12">
            ...
            <span className="flex items-center gap-2">
              ...
              <span className="text-[#393d3f] font-bold text-xs">¥4.2M</span>
            </span>
          </div>
        ))}
      </div>
