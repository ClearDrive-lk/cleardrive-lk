                ...
                <div className="hidden md:flex gap-8 text-sm font-medium text-gray-400">
                    ...
                    {isAuthenticated && (
                        <>
                            <Link
                                href="/dashboard"
                                className={`transition-colors flex items-center gap-2 ${isActive("/dashboard") ? "text-white" : "hover:text-white"
                                    }`}
                            >
                                Dashboard
                                {isActive("/dashboard") && (
                            ...
                            <Link
                                ...
                                className={`transition-colors ${isActive("/dashboard/orders") ? "text-white" : "hover:text-white"
                                    }`}
                            >
                                Orders
                            </Link>
                            <Link
                                ...
                                className={`transition-colors ${isActive("/dashboard/vehicles") ? "text-white" : "hover:text-white"
                                    }`}
                            >
                                Vehicles
                            </Link>
                            <Link
                                ...
                                className={`transition-colors ${isActive("/dashboard/profile") ? "text-white" : "hover:text-white"
                                    }`}
                            >
                                Profile
                            </Link>
