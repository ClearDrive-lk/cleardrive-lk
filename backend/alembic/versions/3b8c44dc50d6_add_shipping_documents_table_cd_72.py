...
def upgrade() -> None:
    ...
    sa.Column('order_id', app.core.models.GUID(), nullable=False),
    sa.Column('user_id', app.core.models.GUID(), nullable=False),
    ...
    sa.Column('reviewed_by', app.core.models.GUID(), nullable=True),
