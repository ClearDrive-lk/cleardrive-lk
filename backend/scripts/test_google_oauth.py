...
def test_google_oauth_flow():
    ...
    test_email = input("\nEnter your test email (e.g., malith@cleardrive.lk): ")
    
    if not test_email:
        test_email = "malith@cleardrive.lk"
...
def test_with_real_google_token():
    ...
    print("   Enter your Client ID and Client Secret from backend/.env (GOOGLE_CLIENT_ID, GOOGLE_CLIENT_SECRET)")
    print("3. In Step 1, select scope: https://www.googleapis.com/auth/userinfo.email https://www.googleapis.com/auth/userinfo.profile openid")
